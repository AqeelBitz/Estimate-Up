...
const InputRound3 = () => {
    ...
    function HandleSubmit(e){
        ...
        updateEstimationData(estimator,round3)
        function updateEstimationData(estimatorName, round3Estimations) {
            ...
            //     console.error("estimationData is not an array");
            //     return;
            //   }
    ...
    return (
        ...
        <input type="text" class="form-control col-md-4" placeholder='Name of estimator' style={{marginBottom:'5px'}} value={estimator} onChange={(e)=>{setEstimator(e.target.value)}} required/>
